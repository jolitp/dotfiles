...
# NOTE I can't make it work
# HELPER: removes file(s) from dotfiles .gitignore
# _dtf_stop_ignoring () {
#   FILES="$@"
#   # go through each argument passed
#   for file in $FILES
#   do
#     result=""
#     sed 's/$HOME//' file > $result
#     echo "result: $result"
#     # line="!$PWD/$file"
#     # echo $line
#     # echo "grep -Fxq $line ~/.gitignore"
#     # check if the passed arguments are present in the file
#     # if grep -Fxq $line ~/.gitignore 
#     # then 
#     #   echo "$line already in .gitignore"
#     # else
#     #   # append the name of the file relative to $HOME
#     #   echo "$line" >> ~/.gitignore
#     # fi
#   done
# }
